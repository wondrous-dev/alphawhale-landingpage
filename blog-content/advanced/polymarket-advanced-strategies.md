...
- How does outcome A affect market B?
- What correlations exist between markets?
- Are related markets consistently priced?

**Example:** If a presidential primary candidate's odds shift significantly, how should that affect general election markets? State-level markets? Policy markets?
...
- Understand how positions move together
...
**Information timing:**
- Pre-position before expected news
...
**Direct hedging:**
- Opposite positions in related markets
...
**Internal arbitrage:**
- Prices within Polymarket that don't reconcile
...
**Model building:**
- Develop probability models from data
...
**Identifying crowd errors:**
- When does sentiment overshoot?
- What triggers overreaction?
- Where are systematic biases?

**Timing contrarian trades:**
...
**Capital efficiency:**
- Maximize exposure per unit of risk
